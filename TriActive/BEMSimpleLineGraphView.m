...
- (void)commonInit {
    ...
    _labelFont = [UIFont fontWithName:DEFAULT_FONT_NAME size:8];
...
#pragma clang diagnostic pop
        ...
        UILabel *firstLabel = [[UILabel alloc] initWithFrame:CGRectMake(5+self.YAxisLabelXOffset, self.frame.size.height-20, viewWidth/2, 20)];
        ...
        UILabel *lastLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width/2 - 5, self.frame.size.height-20, self.frame.size.width/2, 20)];
...
- (NSNumber *)calculateMinimumPointValue {
    if (dataPoints.count > 0) {
        ...
        NSNumber *value = [expression expressionValueWithObject:nil context:nil];
        MALog(@"calculateMinimumPointValue%@",value);
        return value;
    } else return 0;
}
...
- (NSNumber *)calculateMaximumPointValue {
    ...
    NSNumber *value = [expression expressionValueWithObject:nil context:nil];
    MALog(@"calculateMaximumPointValue%@",value);
    return value;
}
