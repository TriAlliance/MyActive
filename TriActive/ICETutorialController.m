...
@property (nonatomic, strong, readonly) UIImageView *btnBackground;
@property (nonatomic, strong, readonly) UIImageView *btnBckLine;
...
- (instancetype)initWithPages:(NSArray *)pages {
    ...
    if (self) {
        ...
        _btnBackground = [[UIImageView alloc] init];
        _btnBckLine = [[UIImageView alloc] init];
...
//    [self.overlayTitle setTextAlignment:NSTextAlignmentCenter];
    ...
    // BtnBackground
//    self.btnBackground.frame = CGRectMake(0, 518, 320, 50);
//    self.btnBckLine.frame = CGRectMake(160, 528, 1, 30);
    self.btnBackground.image = [UIImage imageNamed:@"sign-in-register-btn-bg.png"];
    self.btnBckLine.image = [UIImage imageNamed:@"sign-in-register-line.png"];
...
//    [self.view addSubview:self.overlayTitle];
    ...
    [self.view addSubview:self.btnBckLine];
...
- (void)addAllConstraints {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_btnBackground,_btnBckLine, _leftButton, _rightButton, _pageControl, _gradientView);
...
//    [constraints addObject:@"H:|-54-[_overlayTitle(==212)]-|"];
    ...
    // BtnBackground
    [self.btnBackground setTranslatesAutoresizingMaskIntoConstraints:NO];
    [self.btnBckLine setTranslatesAutoresizingMaskIntoConstraints:NO];
    [constraints addObject:@"V:[_btnBackground(==50)]-0-|"];
    [constraints addObject:@"V:[_btnBckLine(==30)]-10-|"];
    [constraints addObject:@"H:|-0-[_btnBackground(==320)]"];
    [constraints addObject:@"H:|-160-[_btnBckLine(==1)]"];
    ...
    [constraints addObject:@"V:[_leftButton(==50)]-0-|"];
    [constraints addObject:@"V:[_rightButton(==50)]-0-|"];
...
//    }
    MALoginVC *Obj_Login = VCWithIdentifier(@"MALoginVC");
...
//    }
    MARegisterVC *Obj_Register = VCWithIdentifier(@"MARegisterVC");
