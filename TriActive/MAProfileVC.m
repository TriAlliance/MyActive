...
- (void)viewDidLoad
{
    ...
    if([self.check_push_or_tab isEqualToString:@"push"]){
        
    }else{
        self.navigationItem.leftBarButtonItem = [Utility leftbar:[UIImage imageNamed:@"sideMenu.png"] :self];
    }
    self.navigationController.navigationBar.translucent = NO;
    self.navigationItem.rightBarButtonItem=[Utility rightbar:[UIImage imageNamed:@"icon-profile-settings.png"] :self];
...
-(void)callProfileAPI
{
    ...
    [API userProfileWithInfo:[userInfo mutableCopy] completionHandler:^(NSDictionary *responseDict) {
