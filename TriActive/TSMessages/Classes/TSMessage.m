...
- (void)fadeInCurrentNotification
{
    ...
    [ApplicationDelegate.window addSubview:currentView];
    if ([TSMessage iOS7StyleEnabled]) {
        addStatusBarHeightToVerticalOffset();
    }
...
+ (UIViewController *)defaultViewController
{
    ...
    if (!defaultViewController) {
        MALog(@"TSMessages: It is recommended to set a custom defaultViewController that is used to display the notifications");
