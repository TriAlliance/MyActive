...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            UIImage *backgroundImage = [[UIImage imageNamed:@"headerIOS7.png"] stretchableImageWithLeftCapWidth:0.0 topCapHeight:0.0];
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = [UIColor colorWithRed:24.0f/255.0f green:73.0f/255.0f blue:132.0f/255.0f alpha:1.0f];
            [self addSubview:self.backgroundBlurView];
        }
        
//        UIColor *fontColor = [UIColor colorWithHexString:[current valueForKey:@"textColor"] alpha:1.0];
...
//            UIColor *buttonTitleShadowColor = [UIColor colorWithHexString:[current valueForKey:@"buttonTitleShadowColor"] alpha:1.0];
            UIColor *buttonTitleShadowColor = [UIColor clearColor];
            if (!buttonTitleShadowColor)
            {
                buttonTitleShadowColor = [UIColor clearColor];
            }
