...
+ (NSValueTransformer *)locationJSONTransformer
{
    return [MTLValueTransformer reversibleTransformerWithForwardBlock:^(NSArray *coordinates) {
        ...
        NSLog(@"hhh -- %@    %@",[NSNumber numberWithDouble:coord.latitude], [NSNumber numberWithDouble:coord.latitude]);
        NSLog(@"ggg -- %@",[NSValue valueWithMKCoordinate:coord]);
     // return @"<00000000 00003440 713d0ad7 a3405340>";
